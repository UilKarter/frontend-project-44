...
[![asciicast](https://asciinema.org/a/gOjAa1TN8ImrdJCO.svg)](https://asciinema.org/a/gOjAa1TN8ImrdJCO)
## Игра: "Калькулятор"
Игроку показывается случайное арифметическое выражение (например, 5 + 3). Игрок должен вычислить и ввести правильный результат.
[![asciicast](https://asciinema.org/a/Q7qWiiVOIytG0xOx.svg)](https://asciinema.org/a/Q7qWiiVOIytG0xOx)
## Игра "НОД"
Игроку показываются два случайных числа. Его задача — вычислить и ввести их наибольший общий делитель (GCD).
[![asciicast](https://asciinema.org/a/OYQqt1n26m98UV9y.svg)](https://asciinema.org/a/OYQqt1n26m98UV9y)
...
[![asciicast](https://asciinema.org/a/duKGUyRcGxKCG9et.svg)](https://asciinema.org/a/duKGUyRcGxKCG9et)
## Игра "Простое ли число?"
Игроку показывается число. Игроку нужно определить, является ли оно простым, и ответить «yes» или «no».
[![asciicast](https://asciinema.org/a/f4z3NFDskwoabUND.svg)](https://asciinema.org/a/f4z3NFDskwoabUND)
## Установка
Требования:
